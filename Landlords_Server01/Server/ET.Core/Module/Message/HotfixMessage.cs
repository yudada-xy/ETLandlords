...
namespace ETModel {
  ...
  ///发送准备
  /// </summary>
  public partial class C2G_ReadyLand_Ntt : pb::IMessage {
    private static readonly pb::MessageParser<C2G_ReadyLand_Ntt> _parser = new pb::MessageParser<C2G_ReadyLand_Ntt>(() => (C2G_ReadyLand_Ntt)MessagePool.Instance.Fetch(typeof(C2G_ReadyLand_Ntt)));
    public static pb::MessageParser<C2G_ReadyLand_Ntt> Parser { get { return _parser; } }
  ...
  public partial class A1001_GetUserInfo_G2C : pb::IMessage {
    ...
    private string userInfoId_ = "";
    public string UserInfoId {
      get { return userInfoId_; }
      set {
        userInfoId_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (Jwel != 0L) {
        ...
        output.WriteInt64(Jwel);
      }
      if (Douzi != 0L) {
        output.WriteRawTag(32);
        output.WriteInt64(Douzi);
      }
      if (UserInfoId.Length != 0) {
        output.WriteRawTag(42);
        output.WriteString(UserInfoId);
      }
      if (RpcId != 0) {
        output.WriteRawTag(208, 5);
        output.WriteInt32(RpcId);
    ...
    public int CalculateSize() {
      ...
      if (Jwel != 0L) {
        size += 1 + pb::CodedOutputStream.ComputeInt64Size(Jwel);
      }
      if (Douzi != 0L) {
        size += 1 + pb::CodedOutputStream.ComputeInt64Size(Douzi);
      }
      if (UserInfoId.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(UserInfoId);
      }
      return size;
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 24: {
            Jwel = input.ReadInt64();
            break;
          }
          case 32: {
            Douzi = input.ReadInt64();
            break;
          }
          case 42: {
            UserInfoId = input.ReadString();
            break;
          }
          case 720: {
            RpcId = input.ReadInt32();
